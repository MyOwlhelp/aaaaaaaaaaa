...
addcmd('pfling',{},function(args, speaker)
	loadstring(game:HttpGet("https://raw.githubusercontent.com/MyOwlhelp/scripts-testing/SynX/aodyasdasdsad.lua"))();
end)
...
addcmd('synapsexreal',{},function(args, speaker)
	loadstring(game:HttpGet("https://raw.githubusercontent.com/MyOwlhelp/scripts-testing/SynX/Synapse%20X%20rework.lua"))()
end)

addcmd('syndex', {'dex'}, function(args, speaker)
	notify('Loading', 'Hold on a sec')
	loadstring(game:HttpGet("https://raw.githubusercontent.com/MyOwlhelp/scripts-testing/SynX/DarkDex-Mobile.lua"))()
end)

addcmd('invisiblegui', {'invisgui'}, function(args, speaker)
	notify('Loading', 'Hold on a sec')
	loadstring(game:HttpGet("https://raw.githubusercontent.com/MyOwlhelp/scripts-testing/SynX/sajhdgajdajdwww.lua"))()
end)

addcmd('flynoclip', {'flnoc'}, function(args, speaker)
	notify('Loading', 'Hold on a sec')
	loadstring(game:HttpGet("https://raw.githubusercontent.com/MyOwlhelp/HD-Admin-Noclip/main/Script"))()
end)
...
task.spawn(function()
	...
	if success then
		if currentVersion ~= latestVersionInfo.Version then
			notify('Infinite yield','Synapse edition lol')
		end
