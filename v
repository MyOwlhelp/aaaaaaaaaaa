{
  "global environment": {
      ...
      "setthreadidentity": {
        ...
        "type": "Method",
        "description": "Sets the current thread’s level to level.",
        "insert": "setthreadidentity"
    },
    "getthreadidentity": {
        "label": "getthreadidentity();",
        "type": "Method",
        "description": "Returns the current thread’s security level.",
      ...
      "getgenv": {
          "label": "getgenv();",
          "type": "Method",
          "description": "Returns the environment that will be applied to each script ran by salad.",
          "insert": "getgenv"
      },
      "rconsoleprint": {
          "label": "rconsoleprint();",
